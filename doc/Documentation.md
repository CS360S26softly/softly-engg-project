...
| **US-20** | Approve or Reject Events | As a Admin, I want to approve or reject submitted event requests so that only verified events appear on the platform. | High | Low | 3 | To Do |
...
| **US-12** | Monitor Events | As a Admin, I want to monitor attendance statistics and event reviews so that I can ensure events comply with campus standards. | Medium | Medium | 5 | To Do |
...
| **US-19** | Manage Venues | As a Admin, I want to manage venue availability and resolve booking conflicts so that events are scheduled properly. | High | Medium | 5 | To Do |
| **US-21** | Approve Stalls | As a Admin, I want to approve or reject stall registration requests so that campus activations are regulated. | Medium | Low | 3 | To Do |
| **US-22** | Review PR Requests | As a Admin, I want to review PR item requests from societies so that purchases follow institutional guidelines. | Medium | Medium | 5 | To Do |
